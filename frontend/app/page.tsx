        ...
        <div className="">
            <header className="flex flex-col items-center justify-center gap-5 p-6 header-bg h-[70vh]">
                ...
                <p className="font-normal text-white text-center text-xl">
                    Create and participate in decentralized prediction markets
                    across sports, finance, and pop culture.
                </p>
            ...
            <section className="gap-3 mt-10 px-5 md:px-10 xl:px-[100px]">
                <div className="lg:p-[100px] rounded-lg">
                    ...
                    <h2 className="text-3xl font-normal font-jersey text-center mb-5">
                        Connect and Predict Together!
                    </h2>
                    <div className="flex justify-center gap-4">
                        <Link
                            href={routes.createPool}
                            className="bg-transparent rounded-full transition-all duration-200 hover:bg-[#37B7C3] hover:border-[#37B7C3] shadow-none border  hover:text-[#071952] py-1 px-4"
                        >
                            Twitter
                        </Link>
                        <Link
                            href={routes.dashboard}
                            className="bg-transparent rounded-full transition-all duration-200 hover:bg-[#37B7C3] hover:border-[#37B7C3] shadow-none border  hover:text-[#071952] px-4 py-1"
                        >
                            Telegram
                        </Link>
                    </div>
